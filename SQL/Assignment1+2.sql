...
VALUES			('03',			'title 1', 			'1',			'60',			'long',			'2001/04/04'),
				('01',			'title 2', 			'4',			'60',			'chien',		'2010/04/04'),
				('02',			'title 3', 			'5',			'60',			'tien',			'2002/04/04'),
				('04',			'title 4', 			'6',			'60',			'long',			'2003/04/04'),
				('05',			'title 5', 			'7',			'60',			'dat',			'2000/5/04'),
				('06',			'title 6', 			'18',			'60',			'nguyen',		'2020/04/04'),
				('07',			'title 7', 			'8',			'60',			'nghiep',		'2006/04/04'),
				('08',			'title 8', 			'10',			'60',			'quat',			'2000/8/04'),
				('09',			'title 9', 			'3',			'60',			'thao',			'2000/09/04'),
				('10',			'title 10', 		'9',			'60',			'nhung',		'2000/4/14'); 
